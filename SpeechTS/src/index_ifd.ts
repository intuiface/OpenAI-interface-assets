...
globalThisAny.intuiface_ifd_name = 'SpeechSynthesisTS';
...
async function loadIA()
{
    ...
    const ia = await import('./SpeechSynthesisTS.js');
    ...
    resources['SpeechSynthesisTS']['if.interfaceAsset'] = true;
    resources['SpeechSynthesisTS']['title'] = globalThisAny.iaTitle;
    resources['SpeechSynthesisTS']['description'] = globalThisAny.iaDescription;
    ...
    globalThisAny.intuiface_ifd_file = {
        ...
        'protocol': 'ts',
        'basePath': 'SpeechSynthesisTS',
        'if.dependencies': [
            'SpeechSynthesisTS.js',
            'SpeechSynthesisTS.module.js'
        ],
        'schemas': schemas,
        'resources': resources
    };
    ...
    // write the ifd file
    fs.outputFile('dist/SpeechSynthesisTS.ifd', JSON.stringify(globalThisAny.intuiface_ifd_file), 'utf8', (err: any) => {
        if (err) {
