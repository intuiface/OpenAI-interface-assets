...
globalThisAny.intuiface_ifd_name = 'VisionTS';
...
async function loadIA()
{
    ...
    const ia = await import('./VisionTS.js');
    ...
    resources['VisionTS']['if.interfaceAsset'] = true;
    resources['VisionTS']['title'] = globalThisAny.iaTitle;
    resources['VisionTS']['description'] = globalThisAny.iaDescription;
    ...
    // write the ifd file
    fs.outputFile('dist/VisionTS.ifd', JSON.stringify(globalThisAny.intuiface_ifd_file), 'utf8', (err: any) => {
        if (err) {
