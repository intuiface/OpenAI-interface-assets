...
globalThisAny.intuiface_ifd_name = 'WhisperTS';
...
async function loadIA()
{
    ...
    const ia = await import('./WhisperTS.js');
    ...
    resources['WhisperTS']['if.interfaceAsset'] = true;
    resources['WhisperTS']['title'] = globalThisAny.iaTitle;
    resources['WhisperTS']['description'] = globalThisAny.iaDescription;
    ...
    // write the ifd file
    fs.outputFile('dist/WhisperTS.ifd', JSON.stringify(globalThisAny.intuiface_ifd_file), 'utf8', (err: any) => {
        if (err) {
